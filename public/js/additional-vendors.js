...
(function (factory) {
  ...
  FileInput.prototype = {
    ...
    _initTemplateDefaults: function _initTemplateDefaults() {
      ...
      tFileIcon = '<i class="glyphicon glyphicon-file"></i>'; // noinspection HtmlUnknownAttribute
      ...
      tModalMain = '<div id="' + $h.MODAL_ID + '" class="file-zoom-dialog modal fade" ' + 'tabindex="-1" aria-labelledby="' + tModalLabel + '"></div>';
