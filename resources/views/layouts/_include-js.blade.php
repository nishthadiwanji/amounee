...
<script src="{{asset('js/additional-vendors.js')}}"></script>

@if(App::environment('local'))
<script src="{{asset('js/app.js')}}?v=1.2.1" type="text/javascript"></script>
@else
<script src="{{asset('js/app.min.js')}}?v=1.2.1" type="text/javascript"></script>
@endif
