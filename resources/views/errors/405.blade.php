...
<html lang="en">
	<!--begin::Head-->
	<head>
		@include('layouts._include-meta',['overide_title' => '405 Server Error'])
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="error error-5 d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url('/assets/media/error/bg5.jpg');">
				...
				<div class="container d-flex flex-row-fluid flex-column justify-content-md-center p-12">
					...
					<h1 class="error-title font-weight-boldest mt-10 mt-md-0 mb-12" style="color:#F9AD3B">405</h1>
					<p class="font-weight-boldest display-4">Invalid URL</p>
