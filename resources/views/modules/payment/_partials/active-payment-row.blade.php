                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('payment.edit',[$payment->id_token])}}" class="btn btn-outline-warning btn-sm">
                                        @lang('buttons.edit')
                                    </a>
                                    <button type="button" class="btn btn-outline-danger btn-sm m-btn m-btn--pill m-btn--square m-btn--icon pin-ban-user" data-action="{{route('payment.destroy',[$payment->id_token])}}">
                                        @lang('buttons.delete')
                                    </button>
                                </td>
                            </tr>
